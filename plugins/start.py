...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        buttons = [
            [InlineKeyboardButton("𝙆𝙀𝙋𝙊 𝘼𝙈𝘼𝙏 𝙆𝙊𝙉𝙏𝙊𝙇", callback_data="about")],
            [
                InlineKeyboardButton("𝙅𝙊𝙄𝙉 𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝟭", url=client.invitelink),
                InlineKeyboardButton("𝙅𝙊𝙄𝙉 𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝟮", url=client.invitelink2),
            ],
            [
                InlineKeyboardButton("𝙏𝙐𝙏𝙐𝙋 𝙆𝙊𝙉𝙏𝙊𝙇", callback_data="close"),
            ],
        ]
